...
- Search discovery files: `public/robots.txt` and `public/sitemap.xml` are present for the GitHub Pages staging URL.
...
- The current canonical, Open Graph, JSON-LD and sitemap URLs use GitHub Pages. Replace them with the final Cloudflare/custom-domain URLs after DNS and hosting are selected.
